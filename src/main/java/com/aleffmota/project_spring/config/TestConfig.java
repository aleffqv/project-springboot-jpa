package com.aleffmota.project_spring.config;
...
import com.aleffmota.project_spring.entities.Payment;
import com.aleffmota.project_spring.entities.Product;
import com.aleffmota.project_spring.entities.User;
import com.aleffmota.project_spring.entities.enums.OrderStatus;
import com.aleffmota.project_spring.repositories.CategoryRepository;
import com.aleffmota.project_spring.repositories.OrderItemRepository;
...
import com.aleffmota.project_spring.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2024-07-21T03:42:10Z"), OrderStatus.WAIING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2024-07-22T15:21:22Z"), OrderStatus.WAIING_PAYMENT, u1);
